...
function registerPushwooshIOS() {
    ...
    pushNotification.registerDevice({alert:true, badge:true, sound:true, pw_appid:"A983D-382D6", appname:"DeRose Martinez"},
                                    function(status) {
...
function registerPushwooshAndroid() {
    ...
    pushNotification.registerDevice({ projectid: "330731156303", appid : "A983D-382D6" },
                                    function(token) {
                                        //alert(token);
